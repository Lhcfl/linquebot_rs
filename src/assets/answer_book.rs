pub const ANSWERS: &[&str] = &[
    ...
    "这将是一种享受",
    "欲速则不达",
    "A Strong Commitment Returns Better Results",
    "背不动的就放下",
    "这将很美好",
    "准备迎接意外",
    "对他人慷慨",
    ...
    "调查研究，然后享受它",
    "总会慢慢淡去的",
    "Act A Though It Is Already Real",
    "观察形势",
    "是的，但不要强迫",
    ...
    "使人警惕起来",
    "这事情要靠缘分",
    "If you have seen the sea, you will not care about the right and wrong of the pond",
    "列个清单",
    "选择太多和选择太少一样困难",
    "你也许会失望",
    "这会带来好运",
